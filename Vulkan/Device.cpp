...
namespace SEVIAN {
	namespace VULKAN {
		...
		VkDescriptorSetLayout Device::createDescriptorSetLayout ( std::vector<DescriptorSetLayoutInfo> info ) {
			VkDescriptorSetLayout descriptorSetLayout1;
			...
			for (const auto& _info : info) {
				...
				if (_info.descriptorType == VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER) {
					...
					VkDescriptorSetLayoutBinding uboLayoutBinding {};
					uboLayoutBinding.binding = _info.binding;
					uboLayoutBinding.descriptorCount = 1;
					uboLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
					uboLayoutBinding.pImmutableSamplers = nullptr;
					...
					VkDescriptorSetLayoutBinding samplerLayoutBinding {};
					samplerLayoutBinding.binding = _info.binding;
					samplerLayoutBinding.descriptorCount = 1;
					samplerLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
					samplerLayoutBinding.pImmutableSamplers = nullptr;
					samplerLayoutBinding.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;
		...
		std::vector<VkDescriptorSet> Device::createDescriptorSets ( std::vector <DescriptorSetInfo> info ) {
			auto framesCount = MAX_FRAMES_IN_FLIGHT;
		...
		std::vector<VkDescriptorSet> Device::createDescriptorSets ( VkDescriptorSetLayout descriptorSetLayout, std::vector<DescriptorSetInfo> info ) {
			auto framesCount = MAX_FRAMES_IN_FLIGHT;
		...
		Pipeline Device::createGraphPipeline ( VkVertexInputBindingDescription bindingDescription, std::vector<VkVertexInputAttributeDescription> attributeDescriptions, std::vector<VkDescriptorSetLayout> descriptorSetLayouts, std::string vertSource, std::string fragSource ) {
