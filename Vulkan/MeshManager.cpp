...
namespace SEVIAN {
	namespace VULKAN {
		MeshManager::MeshManager ( Device* device, TextureManager* textureManager ) : device ( device ), textureManager ( textureManager ) {
			...
			std::vector<DescriptorSetLayoutInfo> texDSLInfo;
			...
			std::vector<DescriptorSetLayoutInfo> bufDSLInfo2;
		...
		std::unique_ptr<RENDERER::Entity3D> MeshManager::create ( SEVIAN::Info3D info ) {
