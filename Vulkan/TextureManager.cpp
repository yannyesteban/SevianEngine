...
std::unique_ptr<VulkanTexture> SEVIAN::TextureManager::createTexture ( const char* src ) {
...
void SEVIAN::TextureManager::add ( std::string name, std::string path ) {
...
void SEVIAN::TextureManager::add ( SEVIAN::TextureInfo info ) {
...
std::shared_ptr<VulkanTexture> SEVIAN::TextureManager::get ( std::string name ) {
