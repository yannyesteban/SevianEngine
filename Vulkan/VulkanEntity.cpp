...
SEVIAN::VulkanEntity::VulkanEntity ( Device* device, TextureManager* textureManager, Info3D info ) : device ( device ), textureManager ( textureManager ), info ( info ) {
...
void SEVIAN::VulkanEntity::render ( UniformBufferObject ubo ) {
